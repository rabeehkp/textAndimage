...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "carDetails", for: indexPath)
//        let carNames = cars[indexPath.row]
//        cell.textLabel?.text = carNames
//        cell.imageView?.image = UIImage(named: carNames)
        // Configure the cell...
